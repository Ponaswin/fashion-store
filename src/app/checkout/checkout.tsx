        ...
        <div className='w-[80%] flex gap-4  p-5 mx-auto bg-gray-100 rounded  my-5'>
            ...
            <div className='w-[60%] px-[25px]'>
                ...
                <div className='border-b-[1px] border-gray-500 flex gap-5 pb-5 flex-col'>
                    ...
                    <input type="text" className='w-full ps-2 border h-[50px] ' placeholder='username or email address*' />
                </div>

                <div className='flex flex-col border-b-[1px] border-gray-500 pb-5 my-[30px] gap-5'>
                    <div className=''>
                        <p className="mb-2">Billing details</p>
                        <div className='flex gap-2 items-center'><input placeholder='first name' className='w-[50%] ps-2 border h-[50px] ' type="text" />
                            <input type="text" placeholder='last name' className='w-[50%] ps-2 border h-[50px] ' /></div>
                    </div>
                    <input placeholder='company name(optional)' type="text" className='w-[100%] ps-2  border h-[50px] ' />
                    <input type="text" placeholder='Country / Region' className='w-[100%] ps-2  border h-[50px] ' />
                    <div className='flex gap-2 items-center'><input placeholder='street address' className='w-[50%] ps-2 border h-[50px] ' type="text" /><input placeholder='apartment, suite, etc. (optional)' type="text" className='w-[50%] ps-2 border h-[50px] ' /></div>
                    ...
                    <input placeholder='Phone' type="text" className='w-[100%] ps-2  border h-[50px] ' />
                </div>

                <div>
                    <p>Additional Information</p>
                    <textarea placeholder='Enter your comments' className='w-full ps-2 my-5  border h-[50px] ' />
